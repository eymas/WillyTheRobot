...
The documentation we got should have been up to par, I shouldn't have had to spend a day trying to find sources for some claims, or discover what exactly the purpose of the variable \code{TeaPotPacket[]} is.
