...
3			& Speed\_Sensor\_Right 					& $ Rad/s * Wheel Radius $ 						& [m/s] 		\\ \hline
4			& Speed\_Sensor\_Left 					& $ Rad/s * Wheel Radius $ 						& [m/s] 		\\ \hline
...
7			& Turn\_Output  						& $ Turn\_Error * Ct(s) $ 							& - 			\\ \hline
8			& Drive\_Output 						& $ Drive\_Error * Cd(s) $							& - 			\\ \hline
