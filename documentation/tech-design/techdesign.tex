...
[ accelerometer X byte 1 ]\documentclass{article} % article doctype, possible font size range from 8pt to 20pt with not all being avaiable.
...
\input{sections/motor-controller.tex}
\input{sections/imu.tex}
\input{sections/teb-local-planner.tex}
