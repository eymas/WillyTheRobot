...
def pose_callback(msg):
    ...
    npp1 = new_pose
    new_pose2 = Pose(Point(npp1.position.x, npp1.position.y + 1.0, npp1.position.z), Quaternion(npp1.orientation.x, npp1.orientation.y, npp1.orientation.z + 0.5, npp1.orientation.w))
    npp2 = new_pose2
    new_pose3 = Pose(Point(npp2.position.x - 1.0, npp2.position.y, npp2.position.z), Quaternion(npp2.orientation.x, npp2.orientation.y, npp2.orientation.z + 0.5, npp2.orientation.w))
    npp3 = new_pose3
    new_pose4 = Pose(Point(npp3.position.x, npp3.position.y - 1.0, npp3.position.z), Quaternion(npp3.orientation.x, npp3.orientation.y, npp3.orientation.z + 0.5, npp3.orientation.w))
